...
echo "  - If you forked this repo, set your fork to private (recommended). The Stop"
echo "    hook auto-pushes config after every response; a public fork publishes it all."
echo "    Run: gh repo edit YOUR-USERNAME/dotfiles-claude --visibility private"
