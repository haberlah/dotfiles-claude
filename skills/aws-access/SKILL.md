...
- **MFA enforcement:** Identity Center → Settings → Authentication → Multi-factor authentication → Configure. Standing policy: MFA required, "require them to register an MFA device at sign-in", authenticator apps + passkeys, users self-manage devices.
